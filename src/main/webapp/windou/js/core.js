...
Core.menu={
    ...
    [{
        ...
        data: [[{
            text: "背景1",
            func: function() {
                $(this).attr("style",'background:url(windou/images/background.jpg) repeat right bottom transparent;');
            }
        }, {
            text: "背景2",
            func: function() {
                $(this).attr("style",'background:url(windou/images/background2.jpg) repeat right bottom transparent;');
            }       
        }, {
            text: "背景3",
            func: function() {
                $(this).attr("style",'background:url(windou/images/background3.jpg) repeat right bottom transparent;');
            }       
        }]]
    }]
    ],
...
Core.create = function(obj,opt){    
	...
	//图标名称
	var cosname=obj.context.innerText;
...
var GetTaskSystem = function(obj){
    if(!_cache.TaskSystem){
        _cache.TaskSystem = $('<div class="popup-menu task-menu" style="z-index:99999;bottom:30px;display:none"><ul><li><a menu="close" onclick="fullscreen()" href="javascript:;">全屏</a></li><li><a menu="close" onclick="exitFullscreen()" href="javascript:;">退出全屏</a></li><li><a menu="close" href="javascript:;">关机</a></li></ul></div>');
