						...
						<ul class="account-area">
							<li><a class="login-area dropdown-toggle"
								data-toggle="dropdown">
									...
									<section>
										<h2>
											<span class="profile"><span><shiro:principal property="username"/> </span></span>
										</h2>
									</section>
							</a> <!--Login Area Dropdown-->
								<ul
									class="pull-right dropdown-menu dropdown-arrow dropdown-login-area">
									<li class="username"><a>David SSn</a></li>
									<li class="email"><a>W</a></li>
									<!--Avatar Area-->
									<li>
			...
			<div class="page-content">
				...
				<script type="text/javascript" language="javascript">
						...
						for (ibz in data) {
							...
							if (data[ibz].children.length>0) {
								...
								neiron+='<li  id="li_'+data[ibz].id+'" submes="1" >'
										+'<a onclick="gbclass('+data[ibz].id+','+data[ibz].pid+')"  id="a_'+data[ibz].id+'" target="content" href="'+url +'" '+a_class+'>'
									    +'<i class="'+icon+'"></i>'
					...
					$(function(){
						...
						$.post("${pageContext.request.contextPath}/sysresource/menus2",
						          function(data){
