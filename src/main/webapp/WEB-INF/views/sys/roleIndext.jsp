...
<body>
	...
	<div id="dlg" class="easyui-dialog"
		style="width: 500px; height: 200px; padding: 10px 20px"
		data-options="modal:true,closed:'true',buttons:'#bb'">
		<form id="fm" method="post">
		
			<div class="fitem">
				<label>角色名称:</label> <input name="role" class="easyui-textbox" style="width:200px"
											data-options="min:0,precision:0,required:true">
			</div>
			<div class="fitem">
				<label>角色描述:</label> <input name="description" class="easyui-textbox" style="width:200px"
											data-options="min:0,precision:0,required:true">
		</form>
	</div>
	<div id="bb">
	 ...
	 <div id="threedhk" class="easyui-dialog"  style="width:250px;height:400px;"
        data-options="modal:true,title:'Edit RoleResource',closed:'true',buttons:'#threedhk_buttons'">
