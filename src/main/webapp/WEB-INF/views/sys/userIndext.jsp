	...
	<table id="dg" class="easyui-datagrid " style="height:auto"
		...
		<thead>
			<tr>
				...
				<th data-options="field:'sysRolesNamesStr',width:50">用户角色</th>
			</tr>
		</thead>
	</table>
...
<div id="toolbar" style="height:auto;">
	...
	<div id="dlg" class="easyui-dialog"
		...
		data-options="modal:true,closed:'true',buttons:'#bb',title:'添加用户',resizable:true">
		<form id="fm" method="post"
			action="${pageContext.request.contextPath}/user/insertUserPageData">


			<div class="fitem">
				<label>用户名:</label> <input name="username" class="easyui-textbox theme-textbox-radius" style="width:200px"
					data-options="min:0,precision:0,required:true">
			</div>
			<div class="fitem">
				<label>用户密码:</label> <input name="password" class="easyui-textbox theme-textbox-radius" style="width:200px"
					data-options="min:0,precision:0,required:true">
			</div>

			<div class="fitem">
				<label>用户角色:</label> <input id="cc" class="easyui-combobox"  style="width:200px"
					name="rolesid"
					data-options="required:true,multiple:true,valueField:'id',textField:'description',url:'${pageContext.request.contextPath}/role/queryRoleAll'">
			</div>
	...
	<div id="dlgrole" class="easyui-dialog"
		...
		data-options="modal:true,closed:'true',buttons:'#bb_role'">
		<div class="ftitle">修改用户角色</div>
		<form id="fmrole" method="post" action="user/updateUserRolePageData">
			<div class="fitem">
				<label>用户角色:</label> <input id="cc" class="easyui-combobox" style="width:250px"
					name="sysRolesidsStr"
					data-options="required:true,multiple:true,valueField:'id',textField:'description',url:'${pageContext.request.contextPath}/role/queryRoleAll'">
			</div>
	...
	<div id="dlgpassword" class="easyui-dialog"
		...
		data-options="modal:true,closed:'true',buttons:'#b_passwod'">
		<div class="ftitle">修改密码</div>
		<form id="fmpassword" method="post"
			action="user/updateUserPasswordPageData">
			<div class="fitem">
			...
			<input name="salt" type="hidden"> <input name="username"
				type="hidden">
	...
	<div id="bb">
		<a class="easyui-linkbutton" data-options="iconCls:'icon-ok'"
			onclick="subfrom('#fm')">保存</a> <a class="easyui-linkbutton"
	...
	<div id="b_passwod">
		<a class="easyui-linkbutton" data-options="iconCls:'icon-ok'"
			onclick="subfrom('#fmpassword')">保存</a> <a class="easyui-linkbutton"
			data-options="iconCls:'icon-cancel'"
			onclick="javascript: $('#dlgpassword').dialog('close')">关闭</a>
	</div>

	<div id="bb_role">
		<a class="easyui-linkbutton" data-options="iconCls:'icon-ok'"
			onclick="subfrom('#fmrole')">保存</a> <a class="easyui-linkbutton"
			data-options="iconCls:'icon-cancel'"
			onclick="javascript: $('#dlgrole').dialog('close')">关闭</a>
	</div>
</body>
