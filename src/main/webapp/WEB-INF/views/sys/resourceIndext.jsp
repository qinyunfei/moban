...
<script type="text/javascript">
	...
	function newUser() {
		...
		//设置url地址
		url = '${pageContext.request.contextPath}/sysresource/insertResource';
	}
	//添加子资源
	function newSubUser() {
		//获取选中对象
	...
	function editUser() {
		...
		if (row) {
			...
			$('#fm').form('load', row);
			//设置url地址
			url = '${pageContext.request.contextPath}/sysresource/updateResource';
		}
	}
			...
			$.messager.confirm(
							...
							function(r) {
								if (r) {
									//ajxa异步删除
									$.post(
													'${pageContext.request.contextPath}/sysresource/deleteResourceById',
													{
														id : row.id
													},
													function(result) {
...
<body>
		<table id="dg" class="easyui-treegrid" data-options="
															url:'${pageContext.request.contextPath}/sysresource/allresource',
															fitColumns:true,
															idField:'id',
															treeField:'name',
															rownumbers:true,
	...
	<div id="dlg" class="easyui-dialog"
		style="width: 500px; height: 320px; padding: 10px 20px"
		data-options="modal:true,closed:'true',buttons:'#bb'">
		<div class="ftitle">父资源:<span id="span"></span></div>
		<form id="fm" method="post">
		
			<div class="fitem">
				<label>资源名称:</label> <input name="name" class="easyui-textbox" style="width:200px"
					data-options="min:0,precision:0,required:true">
			</div>
			<div class="fitem">
				<label>资源类型:</label> 	
				<select id="cc" class="easyui-combobox" name="type" style="width:200px" data-options="min:0,precision:0,required:true">
        						<option value="menu">menu</option>
       						 <option value="button">button</option>
    				</select>
			</div>
			<div class="fitem">
				<label>资源路径:</label> <input name="url" class="easyui-textbox" style="width:200px" data-options="min:0,precision:0,required:true">
			</div>
			<div class="fitem">
				<label>权限标识:</label> <input name="permission" class="easyui-textbox" style="width:200px" data-options="min:0,precision:0,required:true">
			</div>
<!-- 			<div class="fitem">
